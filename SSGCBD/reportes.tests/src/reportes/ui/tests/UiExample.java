...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>ui</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class UiExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.ui"));
				UI root = UiFactory.eINSTANCE.createUI();
