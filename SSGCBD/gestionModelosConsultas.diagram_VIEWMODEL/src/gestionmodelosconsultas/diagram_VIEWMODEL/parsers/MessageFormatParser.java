package gestionmodelosconsultas.diagram_VIEWMODEL.parsers;
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS.bind(
							gestionmodelosconsultas.diagram_VIEWMODEL.part.Messages.MessageFormatParser_InvalidInputError,
