...
public class DepositoEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_VIEWMODEL.edit.policies.DepositoItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof gestionmodelosconsultas.diagram_VIEWMODEL.edit.parts.DepositoNombreEditPart) {
			((gestionmodelosconsultas.diagram_VIEWMODEL.edit.parts.DepositoNombreEditPart) childEditPart)
