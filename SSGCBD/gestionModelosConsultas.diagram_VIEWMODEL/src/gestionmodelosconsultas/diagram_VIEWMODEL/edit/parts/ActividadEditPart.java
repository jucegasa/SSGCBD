...
public class ActividadEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_VIEWMODEL.edit.policies.ActividadItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof gestionmodelosconsultas.diagram_VIEWMODEL.edit.parts.ActividadNombreEditPart) {
			((gestionmodelosconsultas.diagram_VIEWMODEL.edit.parts.ActividadNombreEditPart) childEditPart)
