...
public class UnidadOrganizacionalNombreEditPart extends CompartmentEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_VIEWMODEL.edit.policies.GestionModelosConsultasTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = gestionmodelosconsultas.diagram_VIEWMODEL.providers.GestionModelosConsultasParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					gestionmodelosconsultas.diagram_VIEWMODEL.edit.parts.GestionModelosConsultasEditPartFactory
