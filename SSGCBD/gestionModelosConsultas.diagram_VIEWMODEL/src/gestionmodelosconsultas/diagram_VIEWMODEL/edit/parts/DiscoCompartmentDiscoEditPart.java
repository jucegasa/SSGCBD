...
public class DiscoCompartmentDiscoEditPart extends ListCompartmentEditPart {
	...
	public String getCompartmentName() {
		return gestionmodelosconsultas.diagram_VIEWMODEL.part.Messages.DiscoCompartmentDiscoEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_VIEWMODEL.edit.policies.DiscoCompartmentDiscoItemSemanticEditPolicy());
	}
