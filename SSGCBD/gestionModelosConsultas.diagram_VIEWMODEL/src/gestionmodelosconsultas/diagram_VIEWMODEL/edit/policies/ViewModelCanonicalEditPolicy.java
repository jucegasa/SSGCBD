 ...
 * @generated
 */
public class ViewModelCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasNodeDescriptor> childDescriptors = gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasDiagramUpdater
				.getViewModel_1000SemanticChildren(viewObject);
		for (gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasNodeDescriptor d : childDescriptors) {
	...
	protected void refreshSemantic() {
		...
		List<gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasNodeDescriptor> childDescriptors = gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasDiagramUpdater
				.getViewModel_1000SemanticChildren((View) getHost().getModel());
		...
		for (Iterator<gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasNodeDescriptor next = descriptorsIterator
					.next();
			String hint = gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasVisualIDRegistry
		...
		for (gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasNodeDescriptor next : childDescriptors) {
			String hint = gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasVisualIDRegistry
					.getType(next.getVisualID());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasVisualIDRegistry
			...
			for (Iterator<gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasLinkDescriptor> collectAllLinks(
		...
		case gestionmodelosconsultas.diagram_VIEWMODEL.edit.parts.ViewModelEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasDiagramUpdater
						.getViewModel_1000ContainedLinks(view));
			}
	...
	private Collection<IAdaptable> createConnections(
			Collection<gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasLinkDescriptor> linkDescriptors,
			Domain2Notation domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (gestionmodelosconsultas.diagram_VIEWMODEL.part.GestionModelosConsultasLinkDescriptor nextLinkDescriptor : linkDescriptors) {
