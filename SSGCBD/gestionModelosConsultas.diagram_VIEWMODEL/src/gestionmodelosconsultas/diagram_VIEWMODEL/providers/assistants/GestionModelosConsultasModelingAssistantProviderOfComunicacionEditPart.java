...
public class GestionModelosConsultasModelingAssistantProviderOfComunicacionEditPart
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((gestionmodelosconsultas.diagram_VIEWMODEL.edit.parts.ComunicacionEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			gestionmodelosconsultas.diagram_VIEWMODEL.edit.parts.ComunicacionEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(gestionmodelosconsultas.diagram_VIEWMODEL.edit.parts.ComunicacionEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((gestionmodelosconsultas.diagram_VIEWMODEL.edit.parts.ComunicacionEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			gestionmodelosconsultas.diagram_VIEWMODEL.edit.parts.ComunicacionEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(gestionmodelosconsultas.diagram_VIEWMODEL.providers.GestionModelosConsultasElementTypes.Relacion_4001);
		return types;
	}
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(gestionmodelosconsultas.diagram_VIEWMODEL.edit.parts.ComunicacionEditPart) targetEditPart,
				relationshipType);
	}
