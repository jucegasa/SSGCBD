...
/**
 * This is the item provider adapter for a {@link gestionmodelosconsultas.sysinfo.data.docmgt.Indice} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IndiceItemProvider extends PaqueteItemProvider {
	/**
	 ...
	 * @generated
	 */
	public IndiceItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DocmgtPackage.Literals.INDICE__INDICE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Indice"));
	}
	...
	public String getText(Object object) {
		String label = ((Indice)object).getNombre();
		return label == null || label.length() == 0 ?
			getString("_UI_Indice_type") :
			getString("_UI_Indice_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Indice.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DocmgtPackage.Literals.INDICE__INDICE,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == DocmgtPackage.Literals.INDICE__INDICE;
