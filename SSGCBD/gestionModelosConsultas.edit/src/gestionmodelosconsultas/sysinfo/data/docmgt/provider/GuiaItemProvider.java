...
/**
 * This is the item provider adapter for a {@link gestionmodelosconsultas.sysinfo.data.docmgt.Guia} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GuiaItemProvider extends DocumentoItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Guia_suTipo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Guia_suTipo_feature", "_UI_Guia_type"),
				 DocmgtPackage.Literals.GUIA__SU_TIPO,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Guia)object).getNombre();
