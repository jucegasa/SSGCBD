...
/**
 * This is the item provider adapter for a {@link gestionmodelosconsultas.sysinfo.people.Organizacion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OrganizacionItemProvider extends PaqueteItemProvider {
	/**
	 ...
	 * @generated
	 */
	public OrganizacionItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PeoplePackage.Literals.ORGANIZACION__ORGANIZACION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Organizacion"));
	}
	...
	public String getText(Object object) {
		String label = ((Organizacion)object).getNombre();
		return label == null || label.length() == 0 ?
			getString("_UI_Organizacion_type") :
			getString("_UI_Organizacion_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Organizacion.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PeoplePackage.Literals.ORGANIZACION__ORGANIZACION,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == PeoplePackage.Literals.ORGANIZACION__ORGANIZACION;
