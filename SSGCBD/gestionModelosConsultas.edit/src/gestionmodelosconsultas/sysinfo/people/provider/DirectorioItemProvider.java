...
/**
 * This is the item provider adapter for a {@link gestionmodelosconsultas.sysinfo.people.Directorio} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DirectorioItemProvider extends PaqueteItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DirectorioItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PeoplePackage.Literals.DIRECTORIO__CONTACTO);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Directorio"));
	}
	...
	public String getText(Object object) {
		String label = ((Directorio)object).getNombre();
		return label == null || label.length() == 0 ?
			getString("_UI_Directorio_type") :
			getString("_UI_Directorio_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Directorio.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PeoplePackage.Literals.DIRECTORIO__CONTACTO,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == PeoplePackage.Literals.DIRECTORIO__CONTACTO;
