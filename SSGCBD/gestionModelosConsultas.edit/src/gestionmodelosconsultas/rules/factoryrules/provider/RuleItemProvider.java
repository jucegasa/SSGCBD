...
/**
 * This is the item provider adapter for a {@link gestionmodelosconsultas.rules.factoryrules.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FactoryrulesPackage.Literals.RULE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FactoryrulesPackage.Literals.RULE__LIST_CHILD_RULE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FactoryrulesPackage.Literals.RULE__LIST_CHILD_RULE,
				 FactoryrulesFactory.eINSTANCE.createEntityName()));

		newChildDescriptors.add
			(createChildParameter
				(FactoryrulesPackage.Literals.RULE__LIST_CHILD_RULE,
				 FactoryrulesFactory.eINSTANCE.createRelationName()));
	}
