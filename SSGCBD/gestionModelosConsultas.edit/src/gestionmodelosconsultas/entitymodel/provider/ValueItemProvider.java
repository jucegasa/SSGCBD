...
/**
 * This is the item provider adapter for a {@link gestionmodelosconsultas.entitymodel.Value} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EntitymodelPackage.Literals.VALUE__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addElementoRealizacionValueAttributePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Value_ElementoRealizacionValueAttribute_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Value_ElementoRealizacionValueAttribute_feature", "_UI_Value_type"),
				 EntitymodelPackage.Literals.VALUE__ELEMENTO_REALIZACION_VALUE_ATTRIBUTE,
				 true,
				 false,
				 true,
				 null,
