...
/**
 * This is the item provider adapter for a {@link gestionmodelosconsultas.modeloconsultas.resultset.resultquien.Rol} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RolItemProvider extends ElementoModeloResultadoItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIdRolPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Id Rol feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIdRolPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rol_idRol_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rol_idRol_feature", "_UI_Rol_type"),
				 ResultquienPackage.Literals.ROL__ID_ROL,
				 true,
				 false,
				 false,
	...
	protected void addNombrePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rol_nombre_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rol_nombre_feature", "_UI_Rol_type"),
				 ResultquienPackage.Literals.ROL__NOMBRE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDescripcionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rol_descripcion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rol_descripcion_feature", "_UI_Rol_type"),
				 ResultquienPackage.Literals.ROL__DESCRIPCION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Rol)object).getKey();
