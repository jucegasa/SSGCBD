...
/**
 * This is the item provider adapter for a {@link gestionmodelosconsultas.modeloconsultas.resultset.resultdonde.Deposito} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DepositoItemProvider extends ElementoModeloResultadoItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIdDepositoPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Id Deposito feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIdDepositoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Deposito_idDeposito_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Deposito_idDeposito_feature", "_UI_Deposito_type"),
				 ResultdondePackage.Literals.DEPOSITO__ID_DEPOSITO,
				 true,
				 false,
				 false,
	...
	protected void addDescripcionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Deposito_descripcion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Deposito_descripcion_feature", "_UI_Deposito_type"),
				 ResultdondePackage.Literals.DEPOSITO__DESCRIPCION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Deposito)object).getKey();
