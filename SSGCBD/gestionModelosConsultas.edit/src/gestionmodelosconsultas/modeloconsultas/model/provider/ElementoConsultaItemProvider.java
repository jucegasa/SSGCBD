...
/**
 * This is the item provider adapter for a {@link gestionmodelosconsultas.modeloconsultas.model.ElementoConsulta} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElementoConsultaItemProvider extends ElementoModeloItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ElementoConsultaItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ElementoConsulta)object).getNombre();
		return label == null || label.length() == 0 ?
			getString("_UI_ElementoConsulta_type") :
			getString("_UI_ElementoConsulta_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ElementoConsulta.class)) {
			case ModelPackage.ELEMENTO_CONSULTA__ORDER:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ModelPackage.ELEMENTO_CONSULTA__LIST_CAMPOS:
