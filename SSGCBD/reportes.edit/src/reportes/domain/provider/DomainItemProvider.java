 ...
 * $Id$
 */
package reportes.domain.provider;
...
/**
 * This is the item provider adapter for a {@link reportes.domain.Domain} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Domain_UI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Domain_UI_feature", "_UI_Domain_type"),
				 DomainPackage.Literals.DOMAIN__UI,
				 true,
				 false,
				 true,
				 null,
