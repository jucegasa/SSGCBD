...
public class GestionModelosConsultasCreationWizard extends Wizard implements
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setWindowTitle(gestionmodelosconsultas.diagram_PROYECCION.part.Messages.GestionModelosConsultasCreationWizardTitle);
		setDefaultPageImageDescriptor(gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasDiagramEditorPlugin
	...
	public void addPages() {
		...
		diagramModelFilePage
				.setTitle(gestionmodelosconsultas.diagram_PROYECCION.part.Messages.GestionModelosConsultasCreationWizard_DiagramModelFilePageTitle);
		diagramModelFilePage
				.setDescription(gestionmodelosconsultas.diagram_PROYECCION.part.Messages.GestionModelosConsultasCreationWizard_DiagramModelFilePageDescription);
				...
				if (visible) {
					...
					fileName = fileName
							.substring(
									0,
									fileName.length()
											- ".gestionmodelosconsultas_diagram_PROYECCION".length()); //$NON-NLS-1$
		...
		domainModelFilePage
				.setTitle(gestionmodelosconsultas.diagram_PROYECCION.part.Messages.GestionModelosConsultasCreationWizard_DomainModelFilePageTitle);
		domainModelFilePage
				.setDescription(gestionmodelosconsultas.diagram_PROYECCION.part.Messages.GestionModelosConsultasCreationWizard_DomainModelFilePageDescription);
