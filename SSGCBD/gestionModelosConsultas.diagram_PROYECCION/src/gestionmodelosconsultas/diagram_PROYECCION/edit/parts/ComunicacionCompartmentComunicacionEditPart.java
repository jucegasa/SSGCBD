 ...
 * @generated
 */
public class ComunicacionCompartmentComunicacionEditPart extends
	 ...
	 * @generated
	 */
	public ComunicacionCompartmentComunicacionEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return gestionmodelosconsultas.diagram_PROYECCION.part.Messages.ComunicacionCompartmentComunicacionEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_PROYECCION.edit.policies.ComunicacionCompartmentComunicacionItemSemanticEditPolicy());
		installEditPolicy(
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_PROYECCION.edit.policies.ComunicacionCompartmentComunicacionCanonicalEditPolicy());
	}
	...
	public EditPart getTargetEditPart(Request request) {
		...
		modelPackage.inizializarEEnum(comunicacion);
