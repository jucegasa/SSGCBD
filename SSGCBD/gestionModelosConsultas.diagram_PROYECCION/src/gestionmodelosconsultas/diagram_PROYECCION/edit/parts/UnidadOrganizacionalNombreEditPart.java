 ...
 * @generated
 */
public class UnidadOrganizacionalNombreEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public UnidadOrganizacionalNombreEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_PROYECCION.edit.policies.GestionModelosConsultasTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = gestionmodelosconsultas.diagram_PROYECCION.providers.GestionModelosConsultasParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					gestionmodelosconsultas.diagram_PROYECCION.edit.parts.GestionModelosConsultasEditPartFactory
