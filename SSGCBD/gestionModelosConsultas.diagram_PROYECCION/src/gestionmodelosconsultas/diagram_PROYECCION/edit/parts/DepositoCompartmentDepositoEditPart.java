 ...
 * @generated
 */
public class DepositoCompartmentDepositoEditPart extends
	 ...
	 * @generated
	 */
	public DepositoCompartmentDepositoEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return gestionmodelosconsultas.diagram_PROYECCION.part.Messages.DepositoCompartmentDepositoEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_PROYECCION.edit.policies.DepositoCompartmentDepositoItemSemanticEditPolicy());
		installEditPolicy(
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_PROYECCION.edit.policies.DepositoCompartmentDepositoCanonicalEditPolicy());
	}
	...
	public EditPart getTargetEditPart(Request request) {
		...
		modelPackage.inizializarEEnum(deposito);// codigo adicional
