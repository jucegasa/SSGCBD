...
public class ActividadCompartmentActividadEditPart extends
	...
	public String getCompartmentName() {
		return gestionmodelosconsultas.diagram_PROYECCION.part.Messages.ActividadCompartmentActividadEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_PROYECCION.edit.policies.ActividadCompartmentActividadItemSemanticEditPolicy());
		installEditPolicy(
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_PROYECCION.edit.policies.ActividadCompartmentActividadCanonicalEditPolicy());
	}
