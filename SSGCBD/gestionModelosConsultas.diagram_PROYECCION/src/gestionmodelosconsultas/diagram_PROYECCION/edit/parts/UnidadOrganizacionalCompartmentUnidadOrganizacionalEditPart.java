 ...
 * @generated
 */
public class UnidadOrganizacionalCompartmentUnidadOrganizacionalEditPart extends
	 ...
	 * @generated
	 */
	public UnidadOrganizacionalCompartmentUnidadOrganizacionalEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return gestionmodelosconsultas.diagram_PROYECCION.part.Messages.UnidadOrganizacionalCompartmentUnidadOrganizacionalEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_PROYECCION.edit.policies.UnidadOrganizacionalCompartmentUnidadOrganizacionalItemSemanticEditPolicy());
		installEditPolicy(
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_PROYECCION.edit.policies.UnidadOrganizacionalCompartmentUnidadOrganizacionalCanonicalEditPolicy());
	}
	...
	public EditPart getTargetEditPart(Request request) {
		...
		modelPackage.inizializarEEnum(unidadOrganizacional);// codigo adicional
