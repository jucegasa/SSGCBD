...
public class ActorEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_PROYECCION.edit.policies.ActorItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ActorNombreEditPart) {
			((gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ActorNombreEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureActorNombreFigure());
			return true;
		}
		return false;
	}
	...
	public class ActorFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureActorNombreFigure;
		...
		private void createContents() {
			...
			fFigureActorNombreFigure = new WrappingLabel();

			fFigureActorNombreFigure.setText("Actor");

			GridData constraintFFigureActorNombreFigure = new GridData();
			constraintFFigureActorNombreFigure.verticalAlignment = GridData.CENTER;
			constraintFFigureActorNombreFigure.horizontalAlignment = GridData.CENTER;
			constraintFFigureActorNombreFigure.horizontalIndent = 0;
			constraintFFigureActorNombreFigure.horizontalSpan = 1;
			constraintFFigureActorNombreFigure.verticalSpan = 1;
			constraintFFigureActorNombreFigure.grabExcessHorizontalSpace = true;
			constraintFFigureActorNombreFigure.grabExcessVerticalSpace = true;
			innerClass0.add(fFigureActorNombreFigure,
					constraintFFigureActorNombreFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureActorNombreFigure() {
			return fFigureActorNombreFigure;
		}
