 ...
 * @generated
 */
public class DepositoCompartmentDepositoCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasNodeDescriptor> childDescriptors = gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasDiagramUpdater
				.getDepositoCompartmentDeposito_7022SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return gestionmodelosconsultas.diagram_PROYECCION.edit.parts.Campo8EditPart.VISUAL_ID == gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasNodeDescriptor> childDescriptors = gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasDiagramUpdater
				.getDepositoCompartmentDeposito_7022SemanticChildren((View) getHost()
						.getModel());
