 ...
 * @generated
 */
public class UnidadOrganizacionalCompartmentUnidadOrganizacionalCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ModelPackage.eINSTANCE.getElementoConsulta_ListCampos();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasNodeDescriptor> childDescriptors = gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasDiagramUpdater
				.getUnidadOrganizacionalCompartmentUnidadOrganizacional_7015SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return gestionmodelosconsultas.diagram_PROYECCION.edit.parts.CampoEditPart.VISUAL_ID == gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasNodeDescriptor> childDescriptors = gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasDiagramUpdater
				.getUnidadOrganizacionalCompartmentUnidadOrganizacional_7015SemanticChildren((View) getHost()
						.getModel());
