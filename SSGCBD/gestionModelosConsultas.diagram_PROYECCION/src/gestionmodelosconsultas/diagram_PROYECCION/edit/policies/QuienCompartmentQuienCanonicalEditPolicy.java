 ...
 * @generated
 */
public class QuienCompartmentQuienCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasNodeDescriptor> childDescriptors = gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasDiagramUpdater
				.getQuienCompartmentQuien_7025SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return gestionmodelosconsultas.diagram_PROYECCION.edit.parts.Campo11EditPart.VISUAL_ID == gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasNodeDescriptor> childDescriptors = gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasDiagramUpdater
				.getQuienCompartmentQuien_7025SemanticChildren((View) getHost()
						.getModel());
