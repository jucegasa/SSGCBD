 ...
 * @generated
 */
public class DiscoCompartmentDiscoCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasNodeDescriptor> childDescriptors = gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasDiagramUpdater
				.getDiscoCompartmentDisco_7023SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return gestionmodelosconsultas.diagram_PROYECCION.edit.parts.Campo9EditPart.VISUAL_ID == gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasNodeDescriptor> childDescriptors = gestionmodelosconsultas.diagram_PROYECCION.part.GestionModelosConsultasDiagramUpdater
				.getDiscoCompartmentDisco_7023SemanticChildren((View) getHost()
						.getModel());
