 ...
 * @generated
 */
public class GestionModelosConsultasDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public GestionModelosConsultasDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasDomainNavigatorItem(
