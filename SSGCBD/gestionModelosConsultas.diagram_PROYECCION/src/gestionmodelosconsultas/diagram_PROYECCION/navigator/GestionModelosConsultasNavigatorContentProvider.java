	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case gestionmodelosconsultas.diagram_PROYECCION.edit.parts.UnidadOrganizacionalEditPart.VISUAL_ID: {
			...
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup incominglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_UnidadOrganizacional_2015_incominglinks,
			...
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup outgoinglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_UnidadOrganizacional_2015_outgoinglinks,
		...
		case gestionmodelosconsultas.diagram_PROYECCION.edit.parts.DocumentoEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup incominglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Documento_2016_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup outgoinglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Documento_2016_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ActividadEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup incominglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Actividad_2017_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup outgoinglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Actividad_2017_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ActorEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup incominglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Actor_2018_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup outgoinglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Actor_2018_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ArmarioEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup incominglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Armario_2019_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup outgoinglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Armario_2019_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ComunicacionEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup incominglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Comunicacion_2020_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup outgoinglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Comunicacion_2020_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ContactoEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup incominglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Contacto_2021_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup outgoinglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Contacto_2021_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case gestionmodelosconsultas.diagram_PROYECCION.edit.parts.DepositoEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup incominglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Deposito_2022_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup outgoinglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Deposito_2022_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case gestionmodelosconsultas.diagram_PROYECCION.edit.parts.DiscoEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup incominglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Disco_2023_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup outgoinglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Disco_2023_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case gestionmodelosconsultas.diagram_PROYECCION.edit.parts.InstanciaProcesoEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup incominglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_InstanciaProceso_2024_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup outgoinglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_InstanciaProceso_2024_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case gestionmodelosconsultas.diagram_PROYECCION.edit.parts.QuienEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup incominglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Quien_2025_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup outgoinglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Quien_2025_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case gestionmodelosconsultas.diagram_PROYECCION.edit.parts.RolEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup incominglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Rol_2026_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup outgoinglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Rol_2026_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case gestionmodelosconsultas.diagram_PROYECCION.edit.parts.FechaEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup incominglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Fecha_2027_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup outgoinglinks = new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasNavigatorGroup(
					gestionmodelosconsultas.diagram_PROYECCION.part.Messages.NavigatorGroupName_Fecha_2027_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(
					Collections.singleton(sv),
