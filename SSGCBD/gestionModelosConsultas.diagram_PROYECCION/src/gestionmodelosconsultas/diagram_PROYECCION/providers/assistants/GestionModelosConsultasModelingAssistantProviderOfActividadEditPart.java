 ...
 * @generated
 */
public class GestionModelosConsultasModelingAssistantProviderOfActividadEditPart
		extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ActividadEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ActividadEditPart source) {
		List<IElementType> types = new ArrayList<IElementType>(1);
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ActividadEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ActividadEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ActividadEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(gestionmodelosconsultas.diagram_PROYECCION.providers.GestionModelosConsultasElementTypes.Relacion_4001);
		return types;
	}
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ActividadEditPart) targetEditPart,
				relationshipType);
	}
