package gestionmodelosconsultas.diagram_PROYECCION.parsers;
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS.bind(
							gestionmodelosconsultas.diagram_PROYECCION.part.Messages.MessageFormatParser_InvalidInputError,
