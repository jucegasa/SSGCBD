...
public class GestionModelosConsultasDomainNavigatorContentProvider implements
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof gestionmodelosconsultas.diagram_ENTITY.navigator.GestionModelosConsultasDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((gestionmodelosconsultas.diagram_ENTITY.navigator.GestionModelosConsultasDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new gestionmodelosconsultas.diagram_ENTITY.navigator.GestionModelosConsultasDomainNavigatorItem(
