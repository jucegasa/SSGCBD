...
public class AttributeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_ENTITY.edit.policies.AttributeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof gestionmodelosconsultas.diagram_ENTITY.edit.parts.AttributeNameEditPart) {
			((gestionmodelosconsultas.diagram_ENTITY.edit.parts.AttributeNameEditPart) childEditPart)
