...
public class Attribute2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_ENTITY.edit.policies.Attribute2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof gestionmodelosconsultas.diagram_ENTITY.edit.parts.AttributeName2EditPart) {
			((gestionmodelosconsultas.diagram_ENTITY.edit.parts.AttributeName2EditPart) childEditPart)
	...
	public class AttributeFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			this.add(fFigureAttributeNameFigure);
