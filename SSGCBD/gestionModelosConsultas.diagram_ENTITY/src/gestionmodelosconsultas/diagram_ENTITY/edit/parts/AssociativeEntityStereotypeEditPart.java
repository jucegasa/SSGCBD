 ...
 * @generated
 */
public class AssociativeEntityStereotypeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AssociativeEntityStereotypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new gestionmodelosconsultas.diagram_ENTITY.edit.policies.GestionModelosConsultasTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = gestionmodelosconsultas.diagram_ENTITY.providers.GestionModelosConsultasParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					gestionmodelosconsultas.diagram_ENTITY.edit.parts.GestionModelosConsultasEditPartFactory
