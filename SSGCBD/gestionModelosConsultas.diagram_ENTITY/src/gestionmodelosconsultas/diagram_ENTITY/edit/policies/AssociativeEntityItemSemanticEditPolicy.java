 ...
 * @generated
 */
public class AssociativeEntityItemSemanticEditPolicy
		extends
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (gestionmodelosconsultas.diagram_ENTITY.part.GestionModelosConsultasVisualIDRegistry
					.getVisualID(incomingLink) == gestionmodelosconsultas.diagram_ENTITY.edit.parts.SimpleRelationEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (gestionmodelosconsultas.diagram_ENTITY.part.GestionModelosConsultasVisualIDRegistry
					.getVisualID(outgoingLink) == gestionmodelosconsultas.diagram_ENTITY.edit.parts.SimpleRelationEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (gestionmodelosconsultas.diagram_ENTITY.providers.GestionModelosConsultasElementTypes.SimpleRelation_4001 == req
				.getElementType()) {
			return getGEFWrapper(new gestionmodelosconsultas.diagram_ENTITY.edit.commands.SimpleRelationCreateCommand(
	...
	protected Command getReorientRelationshipCommand(
		...
		case gestionmodelosconsultas.diagram_ENTITY.edit.parts.SimpleRelationEditPart.VISUAL_ID:
			return getGEFWrapper(new gestionmodelosconsultas.diagram_ENTITY.edit.commands.SimpleRelationReorientCommand(
					req));
		}
