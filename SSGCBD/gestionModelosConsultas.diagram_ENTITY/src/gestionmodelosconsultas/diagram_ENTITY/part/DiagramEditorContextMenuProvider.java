...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private gestionmodelosconsultas.diagram_ENTITY.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new gestionmodelosconsultas.diagram_ENTITY.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
