...
public class GestionModelosConsultasDiagramEditorPlugin extends
	 ...
	 * @generated
	 */
	public static final String ID = "gestionModelosConsultas.diagram_ENTITY"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private gestionmodelosconsultas.diagram_ENTITY.part.GestionModelosConsultasDocumentProvider documentProvider;

	/**
	 * @generated
	 */
	private gestionmodelosconsultas.diagram_ENTITY.edit.policies.GestionModelosConsultasBaseItemSemanticEditPolicy.LinkConstraints linkConstraints;

	/**
	 * @generated
	 */
	private gestionmodelosconsultas.diagram_ENTITY.providers.ElementInitializers initializers;
	...
	protected void fillItemProviderFactories(List<AdapterFactory> factories) {
		...
		//factories.add(new RuleItemProviderAdapterFactory());
	 ...
	 * @generated
	 */
	public gestionmodelosconsultas.diagram_ENTITY.part.GestionModelosConsultasDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new gestionmodelosconsultas.diagram_ENTITY.part.GestionModelosConsultasDocumentProvider();
		}
	 ...
	 * @generated
	 */
	public gestionmodelosconsultas.diagram_ENTITY.edit.policies.GestionModelosConsultasBaseItemSemanticEditPolicy.LinkConstraints getLinkConstraints() {
	...
	public void setLinkConstraints(
			gestionmodelosconsultas.diagram_ENTITY.edit.policies.GestionModelosConsultasBaseItemSemanticEditPolicy.LinkConstraints lc) {
	 ...
	 * @generated
	 */
	public gestionmodelosconsultas.diagram_ENTITY.providers.ElementInitializers getElementInitializers() {
		return initializers;
	}
	...
	public void setElementInitializers(
			gestionmodelosconsultas.diagram_ENTITY.providers.ElementInitializers i) {
		this.initializers = i;
	}
