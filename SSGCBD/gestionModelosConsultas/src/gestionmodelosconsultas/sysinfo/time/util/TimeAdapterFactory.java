...
public class TimeAdapterFactory extends AdapterFactoryImpl {
	...
	protected TimeSwitch<Adapter> modelSwitch =
		new TimeSwitch<Adapter>() {
			@Override
			public Adapter caseTime_View(Time_View object) {
				return createTime_ViewAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseCalendario(Calendario object) {
				return createCalendarioAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link gestionmodelosconsultas.sysinfo.time.Time_View <em>Time View</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link gestionmodelosconsultas.sysinfo.time.Calendario <em>Calendario</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link gestionmodelosconsultas.sysinfo.time.Agenda <em>Agenda</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
