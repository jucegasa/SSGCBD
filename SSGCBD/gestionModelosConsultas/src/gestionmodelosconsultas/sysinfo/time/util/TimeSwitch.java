/**
 */
package gestionmodelosconsultas.sysinfo.time.util;
...
public class TimeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TimePackage.TIME_VIEW: {
				Time_View time_View = (Time_View)theEObject;
				T result = caseTime_View(time_View);
				if (result == null) result = casePaquete(time_View);
				if (result == null) result = caseElementoModelo(time_View);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TimePackage.FECHA: {
				Fecha fecha = (Fecha)theEObject;
				T result = caseFecha(fecha);
				if (result == null) result = caseElementoModelo(fecha);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TimePackage.CALENDARIO: {
				Calendario calendario = (Calendario)theEObject;
				T result = caseCalendario(calendario);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TimePackage.AGENDA: {
				Agenda agenda = (Agenda)theEObject;
				T result = caseAgenda(agenda);
				if (result == null) result = casePaquete(agenda);
				if (result == null) result = caseElementoModelo(agenda);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Time View</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Time View</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTime_View(Time_View object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Calendario</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Calendario</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCalendario(Calendario object) {
		return null;
	}
