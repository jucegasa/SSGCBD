...
public class CorePackageImpl extends EPackageImpl implements CorePackage {
	 ...
	 * @see gestionmodelosconsultas.sysinfo.core.CorePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getElementoModelo_Owner() {
		return (EReference)elementoModeloEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getElementoModelo_Contexto() {
	...
	public EAttribute getElementoModelo_Nombre() {
		return (EAttribute)elementoModeloEClass.getEStructuralFeatures().get(2);
	}
	...
	public EReference getElementoModelo_From() {
		return (EReference)elementoModeloEClass.getEStructuralFeatures().get(3);
	}
	...
	public EReference getElementoModelo_To() {
		return (EReference)elementoModeloEClass.getEStructuralFeatures().get(4);
	}
	...
	public void createPackageContents() {
		...
		createEReference(elementoModeloEClass, ELEMENTO_MODELO__OWNER);
		createEReference(elementoModeloEClass, ELEMENTO_MODELO__CONTEXTO);
	...
	public void initializePackageContents() {
		...
		initEReference(getElementoModelo_Owner(), theSysinfoPackage.getPaquete(), theSysinfoPackage.getPaquete_Element(), "owner", null, 0, 1, ElementoModelo.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getElementoModelo_Contexto(), theDocmgtPackage.getIndexEntry(), theDocmgtPackage.getIndexEntry_SuElemento(), "contexto", null, 0, -1, ElementoModelo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
