/**
 */
package gestionmodelosconsultas.sysinfo.core.util;

import gestionmodelosconsultas.sysinfo.core.*;
...
public class CoreSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CorePackage.ELEMENTO_MODELO: {
				ElementoModelo elementoModelo = (ElementoModelo)theEObject;
				T result = caseElementoModelo(elementoModelo);
