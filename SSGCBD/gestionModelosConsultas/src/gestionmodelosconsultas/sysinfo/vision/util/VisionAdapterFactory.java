 ...
 * @generated
 */
public class VisionAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected VisionSwitch<Adapter> modelSwitch =
		new VisionSwitch<Adapter>() {
			@Override
			public Adapter caseVision_View(Vision_View object) {
				return createVision_ViewAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link gestionmodelosconsultas.sysinfo.vision.Vision_View <em>Vision View</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createVision_ViewAdapter() {
		return null;
	}
