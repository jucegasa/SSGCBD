/**
 */
package gestionmodelosconsultas.sysinfo.vision.util;
 ...
 * @generated
 */
public class VisionSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static VisionPackage modelPackage;
	...
	public VisionSwitch() {
		if (modelPackage == null) {
			modelPackage = VisionPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VisionPackage.VISION_VIEW: {
				Vision_View vision_View = (Vision_View)theEObject;
				T result = caseVision_View(vision_View);
				if (result == null) result = casePaquete(vision_View);
				if (result == null) result = caseElementoModelo(vision_View);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Vision View</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Vision View</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVision_View(Vision_View object) {
		return null;
	}
