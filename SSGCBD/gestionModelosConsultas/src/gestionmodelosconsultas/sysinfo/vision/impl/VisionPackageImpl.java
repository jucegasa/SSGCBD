...
import gestionmodelosconsultas.sysinfo.vision.Vision_View;
 ...
 * @generated
 */
public class VisionPackageImpl extends EPackageImpl implements VisionPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass vision_ViewEClass = null;
	 ...
	 * @see gestionmodelosconsultas.sysinfo.vision.VisionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private VisionPackageImpl() {
		super(eNS_URI, VisionFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link VisionPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static VisionPackage init() {
		if (isInited) return (VisionPackage)EPackage.Registry.INSTANCE.getEPackage(VisionPackage.eNS_URI);

		// Obtain or create and register package
		VisionPackageImpl theVisionPackage = (VisionPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof VisionPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new VisionPackageImpl());
		...
		theVisionPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(VisionPackage.eNS_URI, theVisionPackage);
		return theVisionPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getVision_View() {
		return vision_ViewEClass;
	}
	 ...
	 * @generated
	 */
	public VisionFactory getVisionFactory() {
		return (VisionFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		vision_ViewEClass = createEClass(VISION_VIEW);
	}
	...
	public void initializePackageContents() {
		...
		vision_ViewEClass.getESuperTypes().add(theSysinfoPackage.getPaquete());

		// Initialize classes, features, and operations; add parameters
		initEClass(vision_ViewEClass, Vision_View.class, "Vision_View", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	}
