 ...
 * @generated
 */
public class SysinfoPackageImpl extends EPackageImpl implements SysinfoPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gestionmodelosconsultas.sysinfo.SysinfoPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private SysinfoPackageImpl() {
		super(eNS_URI, SysinfoFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link SysinfoPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static SysinfoPackage init() {
		if (isInited) return (SysinfoPackage)EPackage.Registry.INSTANCE.getEPackage(SysinfoPackage.eNS_URI);

		// Obtain or create and register package
		SysinfoPackageImpl theSysinfoPackage = (SysinfoPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SysinfoPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SysinfoPackageImpl());
		...
		theSysinfoPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(SysinfoPackage.eNS_URI, theSysinfoPackage);
		return theSysinfoPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getPaquete_Tipo() {
	 ...
	 * @generated
	 */
	public EReference getPaquete_Element() {
	 ...
	 * @generated
	 */
	public SysinfoFactory getSysinfoFactory() {
		return (SysinfoFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(paqueteEClass, PAQUETE__TIPO);
		createEReference(paqueteEClass, PAQUETE__ELEMENT);
	}
	...
	public void initializePackageContents() {
		...
		VisionPackage theVisionPackage = (VisionPackage)EPackage.Registry.INSTANCE.getEPackage(VisionPackage.eNS_URI);
		...
		getESubpackages().add(theVisionPackage);
		...
		paqueteEClass.getESuperTypes().add(theCorePackage.getElementoModelo());

		// Initialize classes, features, and operations; add parameters
		initEClass(paqueteEClass, Paquete.class, "Paquete", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPaquete_Tipo(), ecorePackage.getEString(), "tipo", null, 0, 1, Paquete.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPaquete_Element(), theCorePackage.getElementoModelo(), theCorePackage.getElementoModelo_Owner(), "element", null, 0, -1, Paquete.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
