...
public class FunctionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FunctionPackage.FUNCTION_VIEW: {
				Function_View function_View = (Function_View)theEObject;
				T result = caseFunction_View(function_View);
				if (result == null) result = casePaquete(function_View);
				if (result == null) result = caseElementoModelo(function_View);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FunctionPackage.ACTIVIDAD: {
				Actividad actividad = (Actividad)theEObject;
				T result = caseActividad(actividad);
				if (result == null) result = caseElementoModelo(actividad);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FunctionPackage.INSTANCIA_PROCESO: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Function View</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Function View</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFunction_View(Function_View object) {
		return null;
	}
