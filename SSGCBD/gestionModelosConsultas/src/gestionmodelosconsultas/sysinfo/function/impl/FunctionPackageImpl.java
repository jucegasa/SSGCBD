...
import gestionmodelosconsultas.sysinfo.function.Function_View;
import gestionmodelosconsultas.sysinfo.function.InstanciaProceso;
import gestionmodelosconsultas.sysinfo.function.Proceso;
...
public class FunctionPackageImpl extends EPackageImpl implements FunctionPackage {
	 ...
	 * @generated
	 */
	private EClass function_ViewEClass = null;
	 ...
	 * @see gestionmodelosconsultas.sysinfo.function.FunctionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getFunction_View() {
		return function_ViewEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getActividad_Ejecutantes() {
	 ...
	 * @generated
	 */
	public EReference getActividad_InstanciaProceso() {
	 ...
	 * @generated
	 */
	public EReference getActividad_Genera() {
		return (EReference)actividadEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getInstanciaProceso_Actividades() {
		return (EReference)instanciaProcesoEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getInstanciaProceso_UnidadOrganizacional() {
		return (EReference)instanciaProcesoEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getInstanciaProceso_ActorResponsable() {
		return (EReference)instanciaProcesoEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		function_ViewEClass = createEClass(FUNCTION_VIEW);
		...
		createEReference(actividadEClass, ACTIVIDAD__EJECUTANTES);
		createEReference(actividadEClass, ACTIVIDAD__INSTANCIA_PROCESO);
		createEReference(actividadEClass, ACTIVIDAD__GENERA);
		...
		createEReference(instanciaProcesoEClass, INSTANCIA_PROCESO__ACTIVIDADES);
		createEReference(instanciaProcesoEClass, INSTANCIA_PROCESO__UNIDAD_ORGANIZACIONAL);
		createEReference(instanciaProcesoEClass, INSTANCIA_PROCESO__ACTOR_RESPONSABLE);
	...
	public void initializePackageContents() {
		...
		function_ViewEClass.getESuperTypes().add(theSysinfoPackage.getPaquete());
		actividadEClass.getESuperTypes().add(theCorePackage.getElementoModelo());
		instanciaProcesoEClass.getESuperTypes().add(theCorePackage.getElementoModelo());

		// Initialize classes, features, and operations; add parameters
		initEClass(function_ViewEClass, Function_View.class, "Function_View", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEReference(getActividad_Ejecutantes(), thePeoplePackage.getActor(), thePeoplePackage.getActor_Ejecuta(), "ejecutantes", null, 1, -1, Actividad.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getActividad_InstanciaProceso(), this.getInstanciaProceso(), this.getInstanciaProceso_Actividades(), "InstanciaProceso", null, 0, 1, Actividad.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getActividad_Genera(), theDocmgtPackage.getDocumento(), theDocmgtPackage.getDocumento_Asociado(), "genera", null, 0, -1, Actividad.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getInstanciaProceso_Actividades(), this.getActividad(), this.getActividad_InstanciaProceso(), "actividades", null, 1, -1, InstanciaProceso.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInstanciaProceso_UnidadOrganizacional(), thePeoplePackage.getUnidadOrganizacional(), thePeoplePackage.getUnidadOrganizacional_Instanciacionesprocesos(), "UnidadOrganizacional", null, 0, 1, InstanciaProceso.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInstanciaProceso_ActorResponsable(), thePeoplePackage.getActor(), thePeoplePackage.getActor_ProcesosResponsable(), "actorResponsable", null, 1, 1, InstanciaProceso.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
