...
public class DataPackageImpl extends EPackageImpl implements DataPackage {
	 ...
	 * @generated
	 */
	private EClass data_ViewEClass = null;
	 ...
	 * @see gestionmodelosconsultas.sysinfo.data.DataPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getData_View() {
		return data_ViewEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getData_View_Indice() {
		return (EReference)data_ViewEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getData_View_Libreria() {
		return (EReference)data_ViewEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getData_View_Orientacion() {
		return (EReference)data_ViewEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getData_View_Glosario() {
		return (EReference)data_ViewEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getData_View_Distribucion() {
		return (EReference)data_ViewEClass.getEStructuralFeatures().get(4);
	}
	...
	public void createPackageContents() {
		...
		data_ViewEClass = createEClass(DATA_VIEW);
		createEReference(data_ViewEClass, DATA_VIEW__INDICE);
		createEReference(data_ViewEClass, DATA_VIEW__LIBRERIA);
		createEReference(data_ViewEClass, DATA_VIEW__ORIENTACION);
		createEReference(data_ViewEClass, DATA_VIEW__GLOSARIO);
		createEReference(data_ViewEClass, DATA_VIEW__DISTRIBUCION);
	}
	...
	public void initializePackageContents() {
		...
		// Add subpackages
		getESubpackages().add(theDocmgtPackage);
		...
		data_ViewEClass.getESuperTypes().add(theSysinfoPackage.getPaquete());

		// Initialize classes, features, and operations; add parameters
		initEClass(data_ViewEClass, Data_View.class, "Data_View", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getData_View_Indice(), theDocmgtPackage.getIndice(), theDocmgtPackage.getIndice_Data_View(), "Indice", null, 1, 1, Data_View.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getData_View_Libreria(), theDocmgtPackage.getLibreria(), theDocmgtPackage.getLibreria_Data_View(), "Libreria", null, 1, 1, Data_View.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getData_View_Orientacion(), theDocmgtPackage.getOrientacion(), theDocmgtPackage.getOrientacion_Data_View(), "Orientacion", null, 1, 1, Data_View.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getData_View_Glosario(), theDocmgtPackage.getGlosario(), theDocmgtPackage.getGlosario_Data_View(), "Glosario", null, 1, 1, Data_View.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getData_View_Distribucion(), theDocmgtPackage.getDistribucion(), theDocmgtPackage.getDistribucion_Data_View(), "Distribucion", null, 1, 1, Data_View.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
