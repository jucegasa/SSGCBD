...
public class DataSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DataPackage.DATA_VIEW: {
				Data_View data_View = (Data_View)theEObject;
				T result = caseData_View(data_View);
				if (result == null) result = casePaquete(data_View);
				if (result == null) result = caseElementoModelo(data_View);
	 ...
	 * @generated
	 */
	public T caseData_View(Data_View object) {
		return null;
	}
