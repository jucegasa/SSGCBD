 ...
 * @generated
 */
public class ComoPackageImpl extends EPackageImpl implements ComoPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gestionmodelosconsultas.modeloconsultas.como.ComoPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ComoPackageImpl() {
		super(eNS_URI, ComoFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ComoPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ComoPackage init() {
		if (isInited) return (ComoPackage)EPackage.Registry.INSTANCE.getEPackage(ComoPackage.eNS_URI);

		// Obtain or create and register package
		ComoPackageImpl theComoPackage = (ComoPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ComoPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ComoPackageImpl());
		...
		theComoPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ComoPackage.eNS_URI, theComoPackage);
		return theComoPackage;
	}
	 ...
	 * @generated
	 */
	public ComoFactory getComoFactory() {
		return (ComoFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		actividadProcesoEClass.getESuperTypes().add(theFunctionPackage.getActividad());
		actividadProcesoEClass.getESuperTypes().add(theModelPackage.getElementoConsulta());
		instanciaProcesoEClass.getESuperTypes().add(theFunctionPackage.getInstanciaProceso());
		instanciaProcesoEClass.getESuperTypes().add(theModelPackage.getElementoConsulta());
