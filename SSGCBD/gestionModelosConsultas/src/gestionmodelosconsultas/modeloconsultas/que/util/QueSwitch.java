 ...
 * @generated
 */
public class QueSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case QuePackage.DOCUMENTO: {
				Documento documento = (Documento)theEObject;
				T result = caseDocumento(documento);
				if (result == null) result = caseDocmgt_Documento(documento);
				if (result == null) result = caseElementoConsulta(documento);
				if (result == null) result = caseElementoModelo(documento);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QuePackage.COMUNICACION: {
				Comunicacion comunicacion = (Comunicacion)theEObject;
				T result = caseComunicacion(comunicacion);
				if (result == null) result = caseComunicacion_Comunicacion(comunicacion);
				if (result == null) result = caseElementoConsulta(comunicacion);
				if (result == null) result = caseDocmgt_Documento(comunicacion);
	 ...
	 * @generated
	 */
	public T caseDocmgt_Documento(gestionmodelosconsultas.sysinfo.data.docmgt.Documento object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseComunicacion_Comunicacion(gestionmodelosconsultas.memoms.comunicacion.Comunicacion object) {
		return null;
	}
