 ...
 * <ul>
 *   <li>{@link gestionmodelosconsultas.modeloconsultas.que.impl.ComunicacionImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link gestionmodelosconsultas.modeloconsultas.que.impl.ComunicacionImpl#getEADiagram <em>EA Diagram</em>}</li>
 *   <li>{@link gestionmodelosconsultas.modeloconsultas.que.impl.ComunicacionImpl#getListCampos <em>List Campos</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ComunicacionImpl extends gestionmodelosconsultas.memoms.comunicacion.impl.ComunicacionImpl implements Comunicacion {
	/**
	...
	protected EClass eStaticClass() {
		return QuePackage.Literals.COMUNICACION;
	}
	...
	public void setOrder(Integer newOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QuePackage.COMUNICACION__ORDER, oldOrder, order));
	}
	...
	public EADiagram getEADiagram() {
		if (eContainerFeatureID() != QuePackage.COMUNICACION__EA_DIAGRAM) return null;
	...
	public NotificationChain basicSetEADiagram(EADiagram newEADiagram, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newEADiagram, QuePackage.COMUNICACION__EA_DIAGRAM, msgs);
		return msgs;
	}
	...
	public void setEADiagram(EADiagram newEADiagram) {
		if (newEADiagram != eInternalContainer() || (eContainerFeatureID() != QuePackage.COMUNICACION__EA_DIAGRAM && newEADiagram != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, QuePackage.COMUNICACION__EA_DIAGRAM, newEADiagram, newEADiagram));
	}
	...
	public EList<Campo> getListCampos() {
		if (listCampos == null) {
			listCampos = new EObjectContainmentWithInverseEList<Campo>(Campo.class, this, QuePackage.COMUNICACION__LIST_CAMPOS, ModelPackage.CAMPO__OWNED_ELEMENTO_CONSULTA);
		}
		return listCampos;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QuePackage.COMUNICACION__EA_DIAGRAM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetEADiagram((EADiagram)otherEnd, msgs);
			case QuePackage.COMUNICACION__LIST_CAMPOS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QuePackage.COMUNICACION__ORDER:
				return getOrder();
			case QuePackage.COMUNICACION__EA_DIAGRAM:
				return getEADiagram();
			case QuePackage.COMUNICACION__LIST_CAMPOS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ElementoConsulta.class) {
			switch (derivedFeatureID) {
				case QuePackage.COMUNICACION__ORDER: return ModelPackage.ELEMENTO_CONSULTA__ORDER;
				case QuePackage.COMUNICACION__EA_DIAGRAM: return ModelPackage.ELEMENTO_CONSULTA__EA_DIAGRAM;
				case QuePackage.COMUNICACION__LIST_CAMPOS: return ModelPackage.ELEMENTO_CONSULTA__LIST_CAMPOS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ElementoConsulta.class) {
			switch (baseFeatureID) {
				case ModelPackage.ELEMENTO_CONSULTA__ORDER: return QuePackage.COMUNICACION__ORDER;
				case ModelPackage.ELEMENTO_CONSULTA__EA_DIAGRAM: return QuePackage.COMUNICACION__EA_DIAGRAM;
				case ModelPackage.ELEMENTO_CONSULTA__LIST_CAMPOS: return QuePackage.COMUNICACION__LIST_CAMPOS;
				default: return -1;
			}
		}
