 ...
 * @generated
 */
public class QuePackageImpl extends EPackageImpl implements QuePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gestionmodelosconsultas.modeloconsultas.que.QuePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private QuePackageImpl() {
		super(eNS_URI, QueFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link QuePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static QuePackage init() {
		if (isInited) return (QuePackage)EPackage.Registry.INSTANCE.getEPackage(QuePackage.eNS_URI);

		// Obtain or create and register package
		QuePackageImpl theQuePackage = (QuePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof QuePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new QuePackageImpl());
		...
		theQuePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(QuePackage.eNS_URI, theQuePackage);
		return theQuePackage;
	}
	 ...
	 * @generated
	 */
	public QueFactory getQueFactory() {
		return (QueFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		documentoEClass.getESuperTypes().add(theDocmgtPackage.getDocumento());
		documentoEClass.getESuperTypes().add(theModelPackage.getElementoConsulta());
		comunicacionEClass.getESuperTypes().add(theComunicacionPackage.getComunicacion());
		comunicacionEClass.getESuperTypes().add(theModelPackage.getElementoConsulta());
