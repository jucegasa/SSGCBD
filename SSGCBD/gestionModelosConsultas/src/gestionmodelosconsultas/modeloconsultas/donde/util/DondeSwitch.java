 ...
 * @generated
 */
public class DondeSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DondePackage.DEPOSITO: {
				Deposito deposito = (Deposito)theEObject;
				T result = caseDeposito(deposito);
				if (result == null) result = caseNetwork_Deposito(deposito);
				if (result == null) result = caseElementoConsulta(deposito);
				if (result == null) result = casePaquete(deposito);
				if (result == null) result = caseElementoModelo(deposito);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DondePackage.DISCO: {
				Disco disco = (Disco)theEObject;
				T result = caseDisco(disco);
				if (result == null) result = caseNetwork_Disco(disco);
				if (result == null) result = caseElementoConsulta(disco);
				if (result == null) result = caseNetwork_Deposito(disco);
				if (result == null) result = casePaquete(disco);
				if (result == null) result = caseElementoModelo(disco);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DondePackage.ARMARIO: {
				Armario armario = (Armario)theEObject;
				T result = caseArmario(armario);
				if (result == null) result = caseNetwork_Armario(armario);
				if (result == null) result = caseElementoConsulta(armario);
				if (result == null) result = caseNetwork_Deposito(armario);
	 ...
	 * @generated
	 */
	public T caseNetwork_Deposito(gestionmodelosconsultas.sysinfo.network.Deposito object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseNetwork_Disco(gestionmodelosconsultas.sysinfo.network.Disco object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseNetwork_Armario(gestionmodelosconsultas.sysinfo.network.Armario object) {
		return null;
	}
