 ...
 * <ul>
 *   <li>{@link gestionmodelosconsultas.modeloconsultas.donde.impl.DepositoImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link gestionmodelosconsultas.modeloconsultas.donde.impl.DepositoImpl#getEADiagram <em>EA Diagram</em>}</li>
 *   <li>{@link gestionmodelosconsultas.modeloconsultas.donde.impl.DepositoImpl#getListCampos <em>List Campos</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DepositoImpl extends gestionmodelosconsultas.sysinfo.network.impl.DepositoImpl implements Deposito {
	/**
	...
	protected EClass eStaticClass() {
		return DondePackage.Literals.DEPOSITO;
	}
	...
	public void setOrder(Integer newOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DondePackage.DEPOSITO__ORDER, oldOrder, order));
	}
	...
	public EADiagram getEADiagram() {
		if (eContainerFeatureID() != DondePackage.DEPOSITO__EA_DIAGRAM) return null;
	...
	public NotificationChain basicSetEADiagram(EADiagram newEADiagram, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newEADiagram, DondePackage.DEPOSITO__EA_DIAGRAM, msgs);
		return msgs;
	}
	...
	public void setEADiagram(EADiagram newEADiagram) {
		if (newEADiagram != eInternalContainer() || (eContainerFeatureID() != DondePackage.DEPOSITO__EA_DIAGRAM && newEADiagram != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DondePackage.DEPOSITO__EA_DIAGRAM, newEADiagram, newEADiagram));
	}
	...
	public EList<Campo> getListCampos() {
		if (listCampos == null) {
			listCampos = new EObjectContainmentWithInverseEList<Campo>(Campo.class, this, DondePackage.DEPOSITO__LIST_CAMPOS, ModelPackage.CAMPO__OWNED_ELEMENTO_CONSULTA);
		}
		return listCampos;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DondePackage.DEPOSITO__EA_DIAGRAM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ElementoConsulta.class) {
			switch (derivedFeatureID) {
				case DondePackage.DEPOSITO__ORDER: return ModelPackage.ELEMENTO_CONSULTA__ORDER;
				case DondePackage.DEPOSITO__EA_DIAGRAM: return ModelPackage.ELEMENTO_CONSULTA__EA_DIAGRAM;
				case DondePackage.DEPOSITO__LIST_CAMPOS: return ModelPackage.ELEMENTO_CONSULTA__LIST_CAMPOS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ElementoConsulta.class) {
			switch (baseFeatureID) {
				case ModelPackage.ELEMENTO_CONSULTA__ORDER: return DondePackage.DEPOSITO__ORDER;
				case ModelPackage.ELEMENTO_CONSULTA__EA_DIAGRAM: return DondePackage.DEPOSITO__EA_DIAGRAM;
				case ModelPackage.ELEMENTO_CONSULTA__LIST_CAMPOS: return DondePackage.DEPOSITO__LIST_CAMPOS;
				default: return -1;
			}
		}
