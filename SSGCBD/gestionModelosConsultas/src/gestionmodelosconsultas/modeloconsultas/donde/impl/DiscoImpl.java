 ...
 * <ul>
 *   <li>{@link gestionmodelosconsultas.modeloconsultas.donde.impl.DiscoImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link gestionmodelosconsultas.modeloconsultas.donde.impl.DiscoImpl#getEADiagram <em>EA Diagram</em>}</li>
 *   <li>{@link gestionmodelosconsultas.modeloconsultas.donde.impl.DiscoImpl#getListCampos <em>List Campos</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DiscoImpl extends gestionmodelosconsultas.sysinfo.network.impl.DiscoImpl implements Disco {
	/**
	...
	protected EClass eStaticClass() {
		return DondePackage.Literals.DISCO;
	}
	...
	public void setOrder(Integer newOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DondePackage.DISCO__ORDER, oldOrder, order));
	}
	...
	public EADiagram getEADiagram() {
		if (eContainerFeatureID() != DondePackage.DISCO__EA_DIAGRAM) return null;
	...
	public NotificationChain basicSetEADiagram(EADiagram newEADiagram, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newEADiagram, DondePackage.DISCO__EA_DIAGRAM, msgs);
		return msgs;
	}
	...
	public void setEADiagram(EADiagram newEADiagram) {
		if (newEADiagram != eInternalContainer() || (eContainerFeatureID() != DondePackage.DISCO__EA_DIAGRAM && newEADiagram != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DondePackage.DISCO__EA_DIAGRAM, newEADiagram, newEADiagram));
	}
	...
	public EList<Campo> getListCampos() {
		if (listCampos == null) {
			listCampos = new EObjectContainmentWithInverseEList<Campo>(Campo.class, this, DondePackage.DISCO__LIST_CAMPOS, ModelPackage.CAMPO__OWNED_ELEMENTO_CONSULTA);
		}
		return listCampos;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DondePackage.DISCO__EA_DIAGRAM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetEADiagram((EADiagram)otherEnd, msgs);
			case DondePackage.DISCO__LIST_CAMPOS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DondePackage.DISCO__ORDER:
				return getOrder();
			case DondePackage.DISCO__EA_DIAGRAM:
				return getEADiagram();
			case DondePackage.DISCO__LIST_CAMPOS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ElementoConsulta.class) {
			switch (derivedFeatureID) {
				case DondePackage.DISCO__ORDER: return ModelPackage.ELEMENTO_CONSULTA__ORDER;
				case DondePackage.DISCO__EA_DIAGRAM: return ModelPackage.ELEMENTO_CONSULTA__EA_DIAGRAM;
				case DondePackage.DISCO__LIST_CAMPOS: return ModelPackage.ELEMENTO_CONSULTA__LIST_CAMPOS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ElementoConsulta.class) {
			switch (baseFeatureID) {
				case ModelPackage.ELEMENTO_CONSULTA__ORDER: return DondePackage.DISCO__ORDER;
				case ModelPackage.ELEMENTO_CONSULTA__EA_DIAGRAM: return DondePackage.DISCO__EA_DIAGRAM;
				case ModelPackage.ELEMENTO_CONSULTA__LIST_CAMPOS: return DondePackage.DISCO__LIST_CAMPOS;
				default: return -1;
			}
		}
