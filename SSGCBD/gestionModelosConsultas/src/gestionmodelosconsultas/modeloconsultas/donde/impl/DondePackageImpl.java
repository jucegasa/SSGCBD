 ...
 * @generated
 */
public class DondePackageImpl extends EPackageImpl implements DondePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gestionmodelosconsultas.modeloconsultas.donde.DondePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private DondePackageImpl() {
		super(eNS_URI, DondeFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link DondePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static DondePackage init() {
		if (isInited) return (DondePackage)EPackage.Registry.INSTANCE.getEPackage(DondePackage.eNS_URI);

		// Obtain or create and register package
		DondePackageImpl theDondePackage = (DondePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof DondePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new DondePackageImpl());
		...
		theDondePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(DondePackage.eNS_URI, theDondePackage);
		return theDondePackage;
	}
	 ...
	 * @generated
	 */
	public DondeFactory getDondeFactory() {
		return (DondeFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		depositoEClass.getESuperTypes().add(theNetworkPackage.getDeposito());
		depositoEClass.getESuperTypes().add(theModelPackage.getElementoConsulta());
		discoEClass.getESuperTypes().add(theNetworkPackage.getDisco());
		discoEClass.getESuperTypes().add(theModelPackage.getElementoConsulta());
		armarioEClass.getESuperTypes().add(theNetworkPackage.getArmario());
		armarioEClass.getESuperTypes().add(theModelPackage.getElementoConsulta());
