 ...
 * <ul>
 *   <li>{@link gestionmodelosconsultas.modeloconsultas.quien.impl.ActorImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link gestionmodelosconsultas.modeloconsultas.quien.impl.ActorImpl#getEADiagram <em>EA Diagram</em>}</li>
 *   <li>{@link gestionmodelosconsultas.modeloconsultas.quien.impl.ActorImpl#getListCampos <em>List Campos</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ActorImpl extends gestionmodelosconsultas.sysinfo.people.impl.ActorImpl implements Actor {
	/**
	...
	protected EClass eStaticClass() {
		return QuienPackage.Literals.ACTOR;
	}
	...
	public void setOrder(Integer newOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QuienPackage.ACTOR__ORDER, oldOrder, order));
	}
	...
	public EADiagram getEADiagram() {
		if (eContainerFeatureID() != QuienPackage.ACTOR__EA_DIAGRAM) return null;
	...
	public NotificationChain basicSetEADiagram(EADiagram newEADiagram, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newEADiagram, QuienPackage.ACTOR__EA_DIAGRAM, msgs);
		return msgs;
	}
	...
	public void setEADiagram(EADiagram newEADiagram) {
		if (newEADiagram != eInternalContainer() || (eContainerFeatureID() != QuienPackage.ACTOR__EA_DIAGRAM && newEADiagram != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, QuienPackage.ACTOR__EA_DIAGRAM, newEADiagram, newEADiagram));
	}
	...
	public EList<Campo> getListCampos() {
		if (listCampos == null) {
			listCampos = new EObjectContainmentWithInverseEList<Campo>(Campo.class, this, QuienPackage.ACTOR__LIST_CAMPOS, ModelPackage.CAMPO__OWNED_ELEMENTO_CONSULTA);
		}
		return listCampos;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QuienPackage.ACTOR__EA_DIAGRAM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetEADiagram((EADiagram)otherEnd, msgs);
			case QuienPackage.ACTOR__LIST_CAMPOS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QuienPackage.ACTOR__ORDER:
				return getOrder();
			case QuienPackage.ACTOR__EA_DIAGRAM:
				return getEADiagram();
			case QuienPackage.ACTOR__LIST_CAMPOS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ElementoConsulta.class) {
			switch (derivedFeatureID) {
				case QuienPackage.ACTOR__ORDER: return ModelPackage.ELEMENTO_CONSULTA__ORDER;
				case QuienPackage.ACTOR__EA_DIAGRAM: return ModelPackage.ELEMENTO_CONSULTA__EA_DIAGRAM;
				case QuienPackage.ACTOR__LIST_CAMPOS: return ModelPackage.ELEMENTO_CONSULTA__LIST_CAMPOS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ElementoConsulta.class) {
			switch (baseFeatureID) {
				case ModelPackage.ELEMENTO_CONSULTA__ORDER: return QuienPackage.ACTOR__ORDER;
				case ModelPackage.ELEMENTO_CONSULTA__EA_DIAGRAM: return QuienPackage.ACTOR__EA_DIAGRAM;
				case ModelPackage.ELEMENTO_CONSULTA__LIST_CAMPOS: return QuienPackage.ACTOR__LIST_CAMPOS;
				default: return -1;
			}
		}
