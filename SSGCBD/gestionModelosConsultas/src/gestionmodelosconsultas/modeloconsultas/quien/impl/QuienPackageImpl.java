 ...
 * @generated
 */
public class QuienPackageImpl extends EPackageImpl implements QuienPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gestionmodelosconsultas.modeloconsultas.quien.QuienPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private QuienPackageImpl() {
		super(eNS_URI, QuienFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link QuienPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static QuienPackage init() {
		if (isInited) return (QuienPackage)EPackage.Registry.INSTANCE.getEPackage(QuienPackage.eNS_URI);

		// Obtain or create and register package
		QuienPackageImpl theQuienPackage = (QuienPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof QuienPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new QuienPackageImpl());
		...
		theQuienPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(QuienPackage.eNS_URI, theQuienPackage);
		return theQuienPackage;
	}
	 ...
	 * @generated
	 */
	public QuienFactory getQuienFactory() {
		return (QuienFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		unidadOrganizacionalEClass.getESuperTypes().add(thePeoplePackage.getUnidadOrganizacional());
		unidadOrganizacionalEClass.getESuperTypes().add(theModelPackage.getElementoConsulta());
		contactoEClass.getESuperTypes().add(thePeoplePackage.getContacto());
		contactoEClass.getESuperTypes().add(theModelPackage.getElementoConsulta());
		actorEClass.getESuperTypes().add(thePeoplePackage.getActor());
		actorEClass.getESuperTypes().add(theModelPackage.getElementoConsulta());
		rolEClass.getESuperTypes().add(thePeoplePackage.getRol());
		rolEClass.getESuperTypes().add(theModelPackage.getElementoConsulta());
		quienEClass.getESuperTypes().add(theModelPackage.getElementoConsulta());
		quienEClass.getESuperTypes().add(thePeoplePackage.getQuien());
