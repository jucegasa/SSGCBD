 ...
 * @generated
 */
public class ResultdondePackageImpl extends EPackageImpl implements ResultdondePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gestionmodelosconsultas.modeloconsultas.resultset.resultdonde.ResultdondePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ResultdondePackageImpl() {
		super(eNS_URI, ResultdondeFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ResultdondePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ResultdondePackage init() {
		if (isInited) return (ResultdondePackage)EPackage.Registry.INSTANCE.getEPackage(ResultdondePackage.eNS_URI);

		// Obtain or create and register package
		ResultdondePackageImpl theResultdondePackage = (ResultdondePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ResultdondePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ResultdondePackageImpl());
		...
		theResultdondePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ResultdondePackage.eNS_URI, theResultdondePackage);
		return theResultdondePackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getDeposito_IdDeposito() {
		return (EAttribute)depositoEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getDeposito_Descripcion() {
		return (EAttribute)depositoEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getDisco_IdDisco() {
	 ...
	 * @generated
	 */
	public EAttribute getDisco_Descripcion() {
		return (EAttribute)discoEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getArmario_IdArmario() {
		return (EAttribute)armarioEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getArmario_Descripcion() {
		return (EAttribute)armarioEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public ResultdondeFactory getResultdondeFactory() {
		return (ResultdondeFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(depositoEClass, DEPOSITO__ID_DEPOSITO);
		createEAttribute(depositoEClass, DEPOSITO__DESCRIPCION);

		discoEClass = createEClass(DISCO);
		createEAttribute(discoEClass, DISCO__ID_DISCO);
		createEAttribute(discoEClass, DISCO__REFERENCIA);
		createEAttribute(discoEClass, DISCO__DESCRIPCION);

		armarioEClass = createEClass(ARMARIO);
		createEAttribute(armarioEClass, ARMARIO__ID_ARMARIO);
		createEAttribute(armarioEClass, ARMARIO__DESCRIPCION);
	}
	...
	public void initializePackageContents() {
		...
		depositoEClass.getESuperTypes().add(theResultsetPackage.getElementoModeloResultado());
		discoEClass.getESuperTypes().add(theResultsetPackage.getElementoModeloResultado());
		armarioEClass.getESuperTypes().add(theResultsetPackage.getElementoModeloResultado());

		// Initialize classes, features, and operations; add parameters
		initEClass(depositoEClass, Deposito.class, "Deposito", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDeposito_IdDeposito(), ecorePackage.getEString(), "idDeposito", null, 0, 1, Deposito.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDeposito_Descripcion(), ecorePackage.getEString(), "descripcion", null, 0, 1, Deposito.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(discoEClass, Disco.class, "Disco", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDisco_IdDisco(), ecorePackage.getEString(), "idDisco", null, 0, 1, Disco.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDisco_Descripcion(), ecorePackage.getEString(), "descripcion", null, 0, 1, Disco.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(armarioEClass, Armario.class, "Armario", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getArmario_IdArmario(), ecorePackage.getEString(), "idArmario", null, 0, 1, Armario.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getArmario_Descripcion(), ecorePackage.getEString(), "descripcion", null, 0, 1, Armario.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}

} //ResultdondePackageImpl
