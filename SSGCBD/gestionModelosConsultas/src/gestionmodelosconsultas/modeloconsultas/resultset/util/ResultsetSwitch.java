 ...
 * @generated
 */
public class ResultsetSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ResultsetPackage.RESULTADO: {
				Resultado resultado = (Resultado)theEObject;
				T result = caseResultado(resultado);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResultsetPackage.ELEMENTO_MODELO_RESULTADO: {
				ElementoModeloResultado elementoModeloResultado = (ElementoModeloResultado)theEObject;
				T result = caseElementoModeloResultado(elementoModeloResultado);
				if (result == null) result = caseResultElement(elementoModeloResultado);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResultsetPackage.RESULT_ELEMENT: {
