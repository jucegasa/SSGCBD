 ...
 * @generated
 */
public class ResultcomoSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ResultcomoPackage.INSTANCIA_PROCESO: {
				InstanciaProceso instanciaProceso = (InstanciaProceso)theEObject;
				T result = caseInstanciaProceso(instanciaProceso);
				if (result == null) result = caseElementoModeloResultado(instanciaProceso);
				if (result == null) result = caseResultElement(instanciaProceso);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResultcomoPackage.ACTIVIDAD_PROCESO: {
				ActividadProceso actividadProceso = (ActividadProceso)theEObject;
				T result = caseActividadProceso(actividadProceso);
				if (result == null) result = caseElementoModeloResultado(actividadProceso);
				if (result == null) result = caseResultElement(actividadProceso);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
