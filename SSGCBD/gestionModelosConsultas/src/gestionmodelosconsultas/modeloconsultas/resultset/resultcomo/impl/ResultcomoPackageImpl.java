 ...
 * @generated
 */
public class ResultcomoPackageImpl extends EPackageImpl implements ResultcomoPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass instanciaProcesoEClass = null;
	 ...
	 * @generated
	 */
	private EClass actividadProcesoEClass = null;
	 ...
	 * @see gestionmodelosconsultas.modeloconsultas.resultset.resultcomo.ResultcomoPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ResultcomoPackageImpl() {
		super(eNS_URI, ResultcomoFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ResultcomoPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ResultcomoPackage init() {
		if (isInited) return (ResultcomoPackage)EPackage.Registry.INSTANCE.getEPackage(ResultcomoPackage.eNS_URI);

		// Obtain or create and register package
		ResultcomoPackageImpl theResultcomoPackage = (ResultcomoPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ResultcomoPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ResultcomoPackageImpl());
		...
		theResultcomoPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ResultcomoPackage.eNS_URI, theResultcomoPackage);
		return theResultcomoPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getInstanciaProceso() {
		return instanciaProcesoEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getInstanciaProceso_IdInstanciaProceso() {
		return (EAttribute)instanciaProcesoEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getInstanciaProceso_Nombre() {
		return (EAttribute)instanciaProcesoEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getInstanciaProceso_Descripcion() {
		return (EAttribute)instanciaProcesoEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getActividadProceso() {
		return actividadProcesoEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getActividadProceso_IdActividadProceso() {
		return (EAttribute)actividadProcesoEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getActividadProceso_Nombre() {
		return (EAttribute)actividadProcesoEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getActividadProceso_Descripcion() {
		return (EAttribute)actividadProcesoEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getActividadProceso_FechaInicio() {
		return (EAttribute)actividadProcesoEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getActividadProceso_FechaFin() {
		return (EAttribute)actividadProcesoEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public ResultcomoFactory getResultcomoFactory() {
		return (ResultcomoFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		instanciaProcesoEClass = createEClass(INSTANCIA_PROCESO);
		createEAttribute(instanciaProcesoEClass, INSTANCIA_PROCESO__ID_INSTANCIA_PROCESO);
		createEAttribute(instanciaProcesoEClass, INSTANCIA_PROCESO__NOMBRE);
		createEAttribute(instanciaProcesoEClass, INSTANCIA_PROCESO__DESCRIPCION);

		actividadProcesoEClass = createEClass(ACTIVIDAD_PROCESO);
		createEAttribute(actividadProcesoEClass, ACTIVIDAD_PROCESO__ID_ACTIVIDAD_PROCESO);
		createEAttribute(actividadProcesoEClass, ACTIVIDAD_PROCESO__NOMBRE);
		createEAttribute(actividadProcesoEClass, ACTIVIDAD_PROCESO__DESCRIPCION);
		createEAttribute(actividadProcesoEClass, ACTIVIDAD_PROCESO__FECHA_INICIO);
		createEAttribute(actividadProcesoEClass, ACTIVIDAD_PROCESO__FECHA_FIN);
	}
	...
	public void initializePackageContents() {
		...
		instanciaProcesoEClass.getESuperTypes().add(theResultsetPackage.getElementoModeloResultado());
		actividadProcesoEClass.getESuperTypes().add(theResultsetPackage.getElementoModeloResultado());

		// Initialize classes, features, and operations; add parameters
		initEClass(instanciaProcesoEClass, InstanciaProceso.class, "InstanciaProceso", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getInstanciaProceso_IdInstanciaProceso(), ecorePackage.getEString(), "idInstanciaProceso", null, 0, 1, InstanciaProceso.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInstanciaProceso_Nombre(), ecorePackage.getEString(), "nombre", null, 0, 1, InstanciaProceso.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInstanciaProceso_Descripcion(), ecorePackage.getEString(), "descripcion", null, 0, 1, InstanciaProceso.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(actividadProcesoEClass, ActividadProceso.class, "ActividadProceso", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getActividadProceso_IdActividadProceso(), ecorePackage.getEString(), "idActividadProceso", null, 0, 1, ActividadProceso.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getActividadProceso_Nombre(), ecorePackage.getEString(), "nombre", null, 0, 1, ActividadProceso.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getActividadProceso_Descripcion(), ecorePackage.getEString(), "descripcion", null, 0, 1, ActividadProceso.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getActividadProceso_FechaInicio(), ecorePackage.getEString(), "fechaInicio", null, 0, 1, ActividadProceso.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getActividadProceso_FechaFin(), ecorePackage.getEString(), "fechaFin", null, 0, 1, ActividadProceso.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}

} //ResultcomoPackageImpl
