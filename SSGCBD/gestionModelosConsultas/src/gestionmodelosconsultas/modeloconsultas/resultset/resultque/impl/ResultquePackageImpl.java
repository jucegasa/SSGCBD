 ...
 * @generated
 */
public class ResultquePackageImpl extends EPackageImpl implements ResultquePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gestionmodelosconsultas.modeloconsultas.resultset.resultque.ResultquePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ResultquePackageImpl() {
		super(eNS_URI, ResultqueFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ResultquePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ResultquePackage init() {
		if (isInited) return (ResultquePackage)EPackage.Registry.INSTANCE.getEPackage(ResultquePackage.eNS_URI);

		// Obtain or create and register package
		ResultquePackageImpl theResultquePackage = (ResultquePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ResultquePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ResultquePackageImpl());
		...
		theResultquePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ResultquePackage.eNS_URI, theResultquePackage);
		return theResultquePackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getDocumento_IdDocumento() {
	 ...
	 * @generated
	 */
	public EAttribute getDocumento_FechaCreacion() {
	 ...
	 * @generated
	 */
	public EAttribute getDocumento_Anexo() {
	 ...
	 * @generated
	 */
	public EAttribute getDocumento_Tipo() {
	 ...
	 * @generated
	 */
	public EAttribute getDocumento_Comentarios() {
		return (EAttribute)documentoEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 * @generated
	 */
	public EAttribute getComunicacion_IdComunicacion() {
		return (EAttribute)comunicacionEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getComunicacion_Asunto() {
		return (EAttribute)comunicacionEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public ResultqueFactory getResultqueFactory() {
		return (ResultqueFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(documentoEClass, DOCUMENTO__ID_DOCUMENTO);
		...
		createEAttribute(documentoEClass, DOCUMENTO__FECHA_CREACION);
		createEAttribute(documentoEClass, DOCUMENTO__ANEXO);
		createEAttribute(documentoEClass, DOCUMENTO__TIPO);
		createEAttribute(documentoEClass, DOCUMENTO__COMENTARIOS);

		comunicacionEClass = createEClass(COMUNICACION);
		createEAttribute(comunicacionEClass, COMUNICACION__ID_COMUNICACION);
	...
	public void initializePackageContents() {
		...
		documentoEClass.getESuperTypes().add(theResultsetPackage.getElementoModeloResultado());
		comunicacionEClass.getESuperTypes().add(theResultsetPackage.getElementoModeloResultado());

		// Initialize classes, features, and operations; add parameters
		initEClass(documentoEClass, Documento.class, "Documento", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDocumento_IdDocumento(), ecorePackage.getEString(), "idDocumento", null, 0, 1, Documento.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDocumento_Estado(), ecorePackage.getEString(), "estado", null, 0, 1, Documento.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDocumento_FechaCreacion(), ecorePackage.getEString(), "fechaCreacion", null, 0, 1, Documento.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDocumento_Anexo(), ecorePackage.getEString(), "anexo", null, 0, 1, Documento.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDocumento_Tipo(), ecorePackage.getEString(), "tipo", null, 0, 1, Documento.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDocumento_Comentarios(), ecorePackage.getEString(), "comentarios", null, 0, 1, Documento.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(comunicacionEClass, Comunicacion.class, "Comunicacion", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getComunicacion_IdComunicacion(), ecorePackage.getEString(), "idComunicacion", null, 0, 1, Comunicacion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
