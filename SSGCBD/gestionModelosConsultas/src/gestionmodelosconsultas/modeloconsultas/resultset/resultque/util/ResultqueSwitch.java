 ...
 * @generated
 */
public class ResultqueSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ResultquePackage.DOCUMENTO: {
				Documento documento = (Documento)theEObject;
				T result = caseDocumento(documento);
				if (result == null) result = caseElementoModeloResultado(documento);
				if (result == null) result = caseResultElement(documento);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResultquePackage.COMUNICACION: {
				Comunicacion comunicacion = (Comunicacion)theEObject;
				T result = caseComunicacion(comunicacion);
				if (result == null) result = caseElementoModeloResultado(comunicacion);
				if (result == null) result = caseResultElement(comunicacion);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Comunicacion</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Comunicacion</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseComunicacion(Comunicacion object) {
		return null;
	}
