 ...
 * @generated
 */
public class CuandoSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CuandoPackage.FECHA: {
				Fecha fecha = (Fecha)theEObject;
				T result = caseFecha(fecha);
				if (result == null) result = caseTime_Fecha(fecha);
				if (result == null) result = caseElementoConsulta(fecha);
	 ...
	 * @generated
	 */
	public T caseTime_Fecha(gestionmodelosconsultas.sysinfo.time.Fecha object) {
		return null;
	}
