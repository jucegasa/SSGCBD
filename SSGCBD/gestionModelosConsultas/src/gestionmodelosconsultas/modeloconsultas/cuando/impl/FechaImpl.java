 ...
 * <ul>
 *   <li>{@link gestionmodelosconsultas.modeloconsultas.cuando.impl.FechaImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link gestionmodelosconsultas.modeloconsultas.cuando.impl.FechaImpl#getEADiagram <em>EA Diagram</em>}</li>
 *   <li>{@link gestionmodelosconsultas.modeloconsultas.cuando.impl.FechaImpl#getListCampos <em>List Campos</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FechaImpl extends gestionmodelosconsultas.sysinfo.time.impl.FechaImpl implements Fecha {
	/**
	...
	protected EClass eStaticClass() {
		return CuandoPackage.Literals.FECHA;
	}
	...
	public void setOrder(Integer newOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CuandoPackage.FECHA__ORDER, oldOrder, order));
	}
	...
	public EADiagram getEADiagram() {
		if (eContainerFeatureID() != CuandoPackage.FECHA__EA_DIAGRAM) return null;
	...
	public NotificationChain basicSetEADiagram(EADiagram newEADiagram, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newEADiagram, CuandoPackage.FECHA__EA_DIAGRAM, msgs);
		return msgs;
	}
	...
	public void setEADiagram(EADiagram newEADiagram) {
		if (newEADiagram != eInternalContainer() || (eContainerFeatureID() != CuandoPackage.FECHA__EA_DIAGRAM && newEADiagram != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CuandoPackage.FECHA__EA_DIAGRAM, newEADiagram, newEADiagram));
	}
	...
	public EList<Campo> getListCampos() {
		if (listCampos == null) {
			listCampos = new EObjectContainmentWithInverseEList<Campo>(Campo.class, this, CuandoPackage.FECHA__LIST_CAMPOS, ModelPackage.CAMPO__OWNED_ELEMENTO_CONSULTA);
		}
		return listCampos;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CuandoPackage.FECHA__EA_DIAGRAM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetEADiagram((EADiagram)otherEnd, msgs);
			case CuandoPackage.FECHA__LIST_CAMPOS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CuandoPackage.FECHA__ORDER:
				return getOrder();
			case CuandoPackage.FECHA__EA_DIAGRAM:
				return getEADiagram();
			case CuandoPackage.FECHA__LIST_CAMPOS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ElementoConsulta.class) {
			switch (derivedFeatureID) {
				case CuandoPackage.FECHA__ORDER: return ModelPackage.ELEMENTO_CONSULTA__ORDER;
				case CuandoPackage.FECHA__EA_DIAGRAM: return ModelPackage.ELEMENTO_CONSULTA__EA_DIAGRAM;
				case CuandoPackage.FECHA__LIST_CAMPOS: return ModelPackage.ELEMENTO_CONSULTA__LIST_CAMPOS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ElementoConsulta.class) {
			switch (baseFeatureID) {
				case ModelPackage.ELEMENTO_CONSULTA__ORDER: return CuandoPackage.FECHA__ORDER;
				case ModelPackage.ELEMENTO_CONSULTA__EA_DIAGRAM: return CuandoPackage.FECHA__EA_DIAGRAM;
				case ModelPackage.ELEMENTO_CONSULTA__LIST_CAMPOS: return CuandoPackage.FECHA__LIST_CAMPOS;
				default: return -1;
			}
		}
