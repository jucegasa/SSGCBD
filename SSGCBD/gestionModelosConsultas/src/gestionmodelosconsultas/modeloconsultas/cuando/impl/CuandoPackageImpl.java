 ...
 * @generated
 */
public class CuandoPackageImpl extends EPackageImpl implements CuandoPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gestionmodelosconsultas.modeloconsultas.cuando.CuandoPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private CuandoPackageImpl() {
		super(eNS_URI, CuandoFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link CuandoPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static CuandoPackage init() {
		if (isInited) return (CuandoPackage)EPackage.Registry.INSTANCE.getEPackage(CuandoPackage.eNS_URI);

		// Obtain or create and register package
		CuandoPackageImpl theCuandoPackage = (CuandoPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof CuandoPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new CuandoPackageImpl());
		...
		theCuandoPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(CuandoPackage.eNS_URI, theCuandoPackage);
		return theCuandoPackage;
	}
	 ...
	 * @generated
	 */
	public CuandoFactory getCuandoFactory() {
		return (CuandoFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		fechaEClass.getESuperTypes().add(theTimePackage.getFecha());
		fechaEClass.getESuperTypes().add(theModelPackage.getElementoConsulta());
