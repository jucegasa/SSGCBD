 ...
 * @generated
 */
public class ComunicacionPackageImpl extends EPackageImpl implements ComunicacionPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass comunicacionEClass = null;
	 ...
	 * @generated
	 */
	private EClass circularEClass = null;
	 ...
	 * @see gestionmodelosconsultas.memoms.comunicacion.ComunicacionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ComunicacionPackageImpl() {
		super(eNS_URI, ComunicacionFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ComunicacionPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ComunicacionPackage init() {
		if (isInited) return (ComunicacionPackage)EPackage.Registry.INSTANCE.getEPackage(ComunicacionPackage.eNS_URI);

		// Obtain or create and register package
		ComunicacionPackageImpl theComunicacionPackage = (ComunicacionPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ComunicacionPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ComunicacionPackageImpl());
		...
		theComunicacionPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ComunicacionPackage.eNS_URI, theComunicacionPackage);
		return theComunicacionPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getComunicacion() {
		return comunicacionEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getComunicacion_Destinatario() {
		return (EReference)comunicacionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getComunicacion_Remitente() {
		return (EReference)comunicacionEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getComunicacion_NumeroRadicado() {
		return (EAttribute)comunicacionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getComunicacion_Asunto() {
		return (EAttribute)comunicacionEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getComunicacion_Contenido() {
		return (EAttribute)comunicacionEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getMemorando_Actividad() {
		return (EReference)memorandoEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getCircular() {
		return circularEClass;
	}
	 ...
	 * @generated
	 */
	public ComunicacionFactory getComunicacionFactory() {
		return (ComunicacionFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		comunicacionEClass = createEClass(COMUNICACION);
		createEReference(comunicacionEClass, COMUNICACION__DESTINATARIO);
		createEReference(comunicacionEClass, COMUNICACION__REMITENTE);
		createEAttribute(comunicacionEClass, COMUNICACION__NUMERO_RADICADO);
		createEAttribute(comunicacionEClass, COMUNICACION__ASUNTO);
		createEAttribute(comunicacionEClass, COMUNICACION__CONTENIDO);

		memorandoEClass = createEClass(MEMORANDO);
		createEReference(memorandoEClass, MEMORANDO__ACTIVIDAD);

		circularEClass = createEClass(CIRCULAR);
	}
	...
	public void initializePackageContents() {
		...
		comunicacionEClass.getESuperTypes().add(theDocmgtPackage.getDocumento());
		memorandoEClass.getESuperTypes().add(this.getComunicacion());
		circularEClass.getESuperTypes().add(this.getComunicacion());

		// Initialize classes, features, and operations; add parameters
		initEClass(comunicacionEClass, Comunicacion.class, "Comunicacion", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getComunicacion_Destinatario(), thePeoplePackage.getContacto(), thePeoplePackage.getContacto_Destinatariocomunicacion(), "destinatario", null, 1, -1, Comunicacion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getComunicacion_Remitente(), thePeoplePackage.getContacto(), thePeoplePackage.getContacto_Remitentecomunicacion(), "remitente", null, 1, 1, Comunicacion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getComunicacion_NumeroRadicado(), ecorePackage.getEString(), "numeroRadicado", null, 0, 1, Comunicacion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getComunicacion_Asunto(), ecorePackage.getEString(), "asunto", null, 0, 1, Comunicacion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getComunicacion_Contenido(), ecorePackage.getEString(), "contenido", null, 0, 1, Comunicacion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(memorandoEClass, Memorando.class, "Memorando", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMemorando_Actividad(), theInfoPackage.getActividad(), theInfoPackage.getActividad_Memorando(), "Actividad", null, 0, -1, Memorando.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(circularEClass, Circular.class, "Circular", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	}

} //ComunicacionPackageImpl
