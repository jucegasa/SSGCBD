/**
 */
package gestionmodelosconsultas.memoms.comunicacion.util;
 ...
 * @generated
 */
public class ComunicacionAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static ComunicacionPackage modelPackage;
	 ...
	 * @generated
	 */
	public ComunicacionAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = ComunicacionPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected ComunicacionSwitch<Adapter> modelSwitch =
		new ComunicacionSwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter caseCircular(Circular object) {
				return createCircularAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link gestionmodelosconsultas.memoms.comunicacion.Memorando <em>Memorando</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link gestionmodelosconsultas.memoms.comunicacion.Circular <em>Circular</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCircularAdapter() {
		return null;
	}
